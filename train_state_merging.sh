...
# train data
for filepath in ${DATA_DIR}/04.04.PT.6.1.*_Train.txt.dat; do
#for filepath in ${DATA_DIR}/04.03.TSL.6.*_Train.txt.dat; do
...
# predict data
for filepath in ${DATA_DIR}/04.04.PT.6.1.*_TestSR.txt.dat; do
#for filepath in ${DATA_DIR}/04.03.TSL.6.*_TestSR.txt.dat; do
  filename=$(basename "$filepath")
  echo "Doing file ${filename}"
