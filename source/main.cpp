...
void run() {
    ...
    if(read_csv) id->read_csv_header(input_stream);
    else id->read_abbadingo_header(input_stream);
...
int main(int argc, char *argv[]){
    ...
    app.add_option("--performfirst", PERFORM_FIRST_POSSIBLE_MERGE, "When set to 1, the first possible merge is performed, instead of the best scoring one. Default=0. Advice: can be used with characteristic samples.");
