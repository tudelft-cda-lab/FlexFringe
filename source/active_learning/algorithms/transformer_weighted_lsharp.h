/**
 * @file transformer_weighted_lsharp.h
...
#ifndef _TRANSFORMER_WEIGHTED_L_SHARP_H_
#define _TRANSFORMER_WEIGHTED_L_SHARP_H_
...
class transformer_weighted_lsharp_algorithm : public weighted_lsharp_algorithm {
  private:
  ...
  protected:
    virtual void query_weights(std::unique_ptr<state_merger>& merger, apta_node* n, inputdata& id,
                              ...
                              std::optional<active_learning_namespace::pref_suf_t> seq_opt) const override;

  public:
    transformer_weighted_lsharp_algorithm(std::shared_ptr<sul_base>& sul, std::unique_ptr<base_teacher>& teacher,
