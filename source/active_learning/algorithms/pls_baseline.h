...
#ifndef _PLS_BASELINE_H_
#define _PLS_BASELINE_H_
...
class pls_baseline : public lsharp_algorithm {
  ...
  public:
    pls_baseline(std::shared_ptr<sul_base>& sul, std::unique_ptr<base_teacher>& teacher, std::unique_ptr<eq_oracle_base>& oracle) 
