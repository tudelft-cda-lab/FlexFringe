...
from model_definitions import AuTransformer, AuAcceptor, DecoderOnly
...
def do_query(seq: list):
  ...
  last_symbol_embedding = list(attn_output[last_symbol_index])

  rvalue = (res[last_symbol_index], last_symbol_embedding)
...
#
  #load_nn_model("/home/robert/Documents/code/Flexfringe/data/active_learning/test_nn_queries/toy_transformers/modularized/decoder_problem_4.pk")
  #seq = [3]
  #print(do_query(seq))
