 ...
 * 
 */
void dfasat_mode::dfasat_status::create_literals(){
    int v, a, i;
    //X(STATE,COLOR)
 ...
 * 
 */
void dfasat_mode::dfasat_status::delete_literals(){
    int v, a, i;
    for(v = 0; v < num_states; v++ )
        free(x[ v ]);
    free(x);
 ...
 * @return int 
 */
int dfasat_mode::dfasat_status::print_clause(bool v1, int l1, bool v2, int l2, bool v3, int l3, bool v4, int l4){
    if(v1 && l1 == -1) return 0;
    if(!v1 && l1 == -2) return 0;
    if(v2  && l2 == -1) return 0;
    if(!v2 && l2 == -2) return 0;
 ...
 * @return int 
 */
int dfasat_mode::dfasat_status::print_clause(bool v1, int l1, bool v2, int l2, bool v3, int l3){
    if(v1 && l1 == -1) return 0;
    if(!v1 && l1 == -2) return 0;
    if(v2  && l2 == -1) return 0;
    if(!v2 && l2 == -2) return 0;
 ...
 * @return int 
 */
int dfasat_mode::dfasat_status::print_clause(bool v1, int l1, bool v2, int l2){
    if(v1 && l1 == -1) return 0;
    if(!v1 && l1 == -2) return 0;
    if(v2  && l2 == -1) return 0;
    if(!v2 && l2 == -2) return 0;
...
bool dfasat_mode::dfasat_status::always_true(int number, bool flag){
    if(number == -1 && flag == true)  return true;
    if(number == -2 && flag == false) return true;
    return false;
}

void dfasat_mode::dfasat_status::print_lit(int number, bool flag){
...
void dfasat_mode::dfasat_status::print_clause_end(){
    if(computing_header) return;
    //fprintf(sat_stream, " 0\n");
    sat_stream << " 0\n";
}
...
void dfasat_mode::dfasat_status::fix_red_values(){
...
void dfasat_mode::dfasat_status::fix_sink_values(){
    for(state_set::iterator it = red_states->begin(); it != red_states->end(); ++it){
        apta_node* node = *it;
        int cr = state_colour[node];
 ...
 * @return int 
 */
int dfasat_mode::dfasat_status::set_symmetry(){
    int num = 0;
...
int dfasat_mode::dfasat_status::print_symmetry(){
    int num = 0;
 ...
 * 
 */
void dfasat_mode::dfasat_status::erase_red_conflict_colours(){
    for(state_set::iterator it = red_states->begin(); it != red_states->end(); ++it){
        apta_node* left = *it;
 ...
 * @return int TODO
 */
int dfasat_mode::dfasat_status::print_colours(){
    int num = 0;
    bool altr = false;
    // at least one
 ...
 * @return int 
 */
int dfasat_mode::dfasat_status::print_conflicts(){
    int num = 0;
    for(state_set::iterator it = non_red_states->begin(); it != non_red_states->end(); ++it){
        apta_node* left = *it;
 ...
 * @return int 
 */
int dfasat_mode::dfasat_status::print_accept(){
    int num = 0;
    for(state_set::iterator it = non_red_states->begin(); it != non_red_states->end(); ++it){
        apta_node* node = *it;
        int nr = state_number[node];
 ...
 * @return int 
 */
int dfasat_mode::dfasat_status::print_transitions(){
    int num = 0;
    for(int a = 0; a < alphabet_size; ++a)
        for(int i = 0; i < dfa_size; ++i)
...
int dfasat_mode::dfasat_status::print_sink_transitions(){
    int num = 0;
    for(int a = 0; a < alphabet_size; ++a)
        for(int i = 0; i < dfa_size; ++i)
...
int dfasat_mode::dfasat_status::print_t_transitions(){
    int num = 0;
    for(int i = 0; i < dfa_size; ++i)
...
int dfasat_mode::dfasat_status::print_p_transitions(){
    int num = 0;
    for(int i = 0; i < dfa_size; ++i){
        for(int j = 0; j < new_states; ++j){
            for(int k = 0; k < i; ++k){
...
int dfasat_mode::dfasat_status::print_a_transitions(){
    int num = 0;
    for(int i = 0; i < new_states; ++i){
        for(int a = 0; a < alphabet_size; ++a){
            for(int j = 0; j < dfa_size; ++j){
...
int dfasat_mode::dfasat_status::print_forcing_transitions(){
    int num = 0;
    bool altr = false;
    for (int label = 0; label < alphabet_size; ++label) {
...
int dfasat_mode::dfasat_status::print_paths(){
    int num = 0;
    for (state_set::iterator it = red_states->begin(); it != red_states->end(); ++it) {
        apta_node* source = *it;
        int nr = state_number[source];
...
/* print sink paths */
int dfasat_mode::dfasat_status::print_sink_paths(){
    int num = 0;
    bool altr = false;
    for (state_set::iterator it = red_states->begin(); it != red_states->end(); ++it) {
        apta_node* source = *it;
...
void dfasat_mode::dfasat_status::print_dot_output(const char* dot_output){
...
void dfasat_mode::dfasat_status::print_aut_output(const char* aut_output){
...
dfasat_mode::dfasat_status::dfasat_status(state_merger* m, int best_solution){
    merger = m;
...
void dfasat_mode::dfasat_status::compute_header() {
...
void dfasat_mode::dfasat_status::translate(FILE* sat_file) {
